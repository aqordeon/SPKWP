...
<body>
    ...
    <center>
        ...
        <br><br><br>
            ...
            <div class="container">
                <h2 style="display: inline;">Kriteria</h2>
                <form method="post" action="" enctype='multipart/form-data'>
                    <label class="radio-inline">
                        <input type="radio" name="optradio_kriteria" value="1">1 <!-- name = optradio1 / optradio2 -->
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio_kriteria" value="2">2
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio_kriteria" value="3">3
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio_kriteria" value="4">4
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="optradio_kriteria" value="5">5
                    </label>
                </form>
