    ...
    <center>
        ...
        <br><br><br>
            ...
            <?php 
                ...
                $hasiltabelkriteria = mysqli_query($con, $tabelkriteria);
                $pecahtabelkriteria = mysqli_num_rows($hasiltabelkriteria);
                
                if ($pecahtabelkriteria > 0) {
                // output data of each row
                while($row = mysqli_fetch_assoc($pecahtabelkriteria)) {
                    echo $row['id'];
                }
                } else {
                echo "0 results";
