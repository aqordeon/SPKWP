...
<body>
    ...
    <center>
        ...
        <?php 
            $ambilkriteria = $con->query("SELECT * FROM tb_kriteria");
            $cekdbkriteria = $ambilkriteria->fetch_assoc();
                ...
                <div class="container">
                    ...
                    <form>
                        <label class="radio-inline">
                            <input type="radio" name="optradio1">1
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optradio1">2
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optradio1">3
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optradio1">4
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="optradio1">5
                        </label>
                    </form>
                </div>
            <?php } ?>
