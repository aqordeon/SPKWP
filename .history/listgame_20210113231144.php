...
<body>
    ...
    <a href="index.php" class="btn btn-light" style="height: 100vh; width: 25vw; position: absolute; ">
        <div style="width: 90%; margin: 0; position: relative; top: 50%; left: 50%; -ms-transform: translate(-50%, -50%); transform: translate(-50%, -50%);">&#8672 Kembali</div>
    </a>
