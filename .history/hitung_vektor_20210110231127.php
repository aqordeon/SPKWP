...
<head>
    ...
    <?php 
        session_start();
        include "koneksi.php";
        function cetak_alternatif($id){
            $ambildata_alternatif = mysqli_query($con, "SELECT nama_game FROM tb_alternatif WHERE $id= ")
        }
    ?>
</head>
<body>
                    ...
                    <table class="table table-striped " style="width: 90%; margin: auto auto;">
                        ...
                        <?php  for ($no=1; $no<count($vektorv); $no++) { ?>
                            <tr>
                                ...
                                <td><?php echo "V" . $no; ?></td>
                                <td><?php echo $_SESSION["namagame"]; ?></td>
