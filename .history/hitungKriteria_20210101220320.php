...
<body>
    ...
    <center>
        ...
        <br><br><br>
            ...
            ?>
        <input type='submit' class="btn btn-primary" value='Submit' name='kriteria_submit'>   <!-- mengarah ke hitung_vektor.php -->
    ...
    <?php
        if(isset($_POST['kriteria_submit'])){
            ...
            $filename = $_FILES['imgproduct']['name']; // Getting file name
            $valid_ext = array('png','jpeg','jpg'); // Valid extension
            $location = "imageproduct/"; // Location
            ...
            $jenisproduct = $_POST['jenis'];
            $stockproduct = $_POST['stokproduk'];
