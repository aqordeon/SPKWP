...
<body>
    <a href="index.php" class="btn btn-outline-light" style="height: 100vh; width: 10vw; position: absolute; border: none; float: right;">
        <h1 style="margin: 0; position: relative; top: 50%; left: 50%; -ms-transform: translate(-50%, -50%); transform: translate(-50%, -50%);">&#8672 Kembali</h1>
    </a>
    <div class="container">
    <center>
        <div class="row">
