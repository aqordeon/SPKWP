        ...
        <br><br><br>
            ...
            <div class="container">
                <form method="post" action="" enctype='multipart/form-data'>
                    ...
                    <input type="radio" id="optradio_tahunrilis1" name="radio_tahunrilis" value="1" required="required"><label for="optradio_tahunrilis1">1</label>&#9
                    <input type="radio" id="optradio_tahunrilis2" name="radio_tahunrilis" value="2"><label for="optradio_tahunrilis2">2</label>&#9
                    <input type="radio" id="optradio_tahunrilis3" name="radio_tahunrilis" value="3"><label for="optradio_tahunrilis3">3</label>&#9
                    <input type="radio" id="optradio_tahunrilis4" name="radio_tahunrilis" value="4"><label for="optradio_tahunrilis4">4</label>&#9
                    <input type="radio" id="optradio_tahunrilis5" name="radio_tahunrilis" value="5"><label for="optradio_tahunrilis5">5</label>&#9
