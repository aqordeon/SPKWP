    ...
    <center>
        <div class="row">
            ...
            ?>
                ...
                <table class="table table-striped " style="width: 90%; margin: 0; position: relative; top: 50%; left: 50%; -ms-transform: translate(-50%, -50%); transform: translate(-50%, -50%);"> <!-- agar center vertical dan horizontal -->
                <h2>Hasil akhir perankingan vektor V</h2><thead class="table-active">
                        <tr>
