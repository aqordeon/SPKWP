        ...
        <br><br><br>
            ...
            <div class="container">
                ...
                <form method="post" action="" enctype='multipart/form-data'>
                    ...
                    <input type="radio" id="optradio_tahunrilis1" name="radio_tahunrilis" value="1"><label for="radio_tahunrilis">1</label>
                    <input type="radio" id="optradio_tahunrilis2" name="radio_tahunrilis" value="2"><label for="radio_tahunrilis">2</label>
                    <input type="radio" id="optradio_tahunrilis3" name="radio_tahunrilis" value="3"><label for="radio_tahunrilis">3</label>
                    <input type="radio" id="optradio_tahunrilis4" name="radio_tahunrilis" value="4"><label for="radio_tahunrilis">4</label>
                    <input type="radio" id="optradio_tahunrilis5" name="radio_tahunrilis" value="5"><label for="radio_tahunrilis">5</label>
